...
excludes = [
    ...
    'PyQt6.QtPdfWidgets', 'PyQt6.QtRemoteObjects', 'PyQt6.QtAxContainer',
...
for binary in a.binaries:
    ...
    skip = any(x in name for x in [
        ...
        'qt6axcontainer', 'qt6dbus', 'qt6texttospeech', 'qt6datavisualization',
        ...
        'avcodec', 'avformat', 'avutil', 'swresample', 'swscale', 'avdevice',
